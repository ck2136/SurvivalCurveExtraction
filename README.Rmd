...
Since it's easier to use the web-application. I'm going to go with the server. Click to access [shinyapps.io](pharmacoecon.shinyapps.io/SurvivalCurveExtraction)
